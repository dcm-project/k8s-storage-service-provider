...
- **And** when omitted, `` or the cluster default MUST be used
...
In v1, `id` (DCM identity) and `metadata.name` (PVC name) are separate identifiers
and are not required to be equal.
