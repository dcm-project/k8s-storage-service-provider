...
var _ = Describe("WriteResponse", func() {
	...
	It("writes a 500 INTERNAL response", func() {
		...
		httperror.WriteResponse(w, logger, http.StatusInternalServerError, v1alpha1.INTERNAL, httperror.InternalTitle, httperror.InternalDetail, util.Ptr("/api/v1alpha1/volumes"))
